...
学号：待填写  
分工：待填写  
代码仓库链接：https://github.com/lhrscw/deep-learning-spatial-intelligence-hw2  
...
当前代码已覆盖三个任务的核心要求：分类微调与消融、检测与跟踪计数、U-Net 从零搭建和 Dice Loss 对比。最终提交前还需要填写首页小组成员、学号和分工，并可将 Task 1/2/3 按 README 的完整 epoch 配置继续训练以提升最终分数。
